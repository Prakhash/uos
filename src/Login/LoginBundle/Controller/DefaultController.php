...
class DefaultController extends Controller {
    ...
    public function roomeditAction(Request $request) {
        if ($request->getMethod() == 'POST') {
            ...
            $room = $repository->findOneBy(array('roomno' => $roomno));
            if ($room) {
                return $this->render('LoginLoginBundle:Default:roomeditf.html.twig', array('roomno' => $room->getRoomno(), 'hallname' => $room->getHallname(), 'type' => $room->getType(), 'cost' => $room->getMonthlycost()));
            } else {
    ...
    public function roomeditfAction(Request $request) {
        ...
        return $this->render('LoginLoginBundle:Default:roomreditf.html.twig');
    }
